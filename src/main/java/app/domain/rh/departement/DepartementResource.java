...
public class DepartementResource {
    ...
    public ResponseEntity<DepartementDto> creer(@Valid @RequestBody DepartementDto departementDto) {
        try {
            return ResponseEntity.status(HttpStatus.CREATED).body(departementService.creer(departementDto));
    ...
    @PutMapping("/{id}")
    public DepartementDto maj(@PathVariable Long id, @Valid @RequestBody DepartementDto departementDto) {
    ...
    @GetMapping("/{id}")
    public DepartementDto recupererParId(@PathVariable Long id) {
        return departementService.recupererParId(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Departement not found"));
    }
