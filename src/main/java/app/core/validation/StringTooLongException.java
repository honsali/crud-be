...
public class StringTooLongException extends AssertionException {
    ...
    static class StringTooLongExceptionBuilder {
        ...
        private String message() {
            return new StringBuilder().append("The value in field \"").append(field).append("\" must be at most ").append(maxLength).append(" long but was ").append(value.length()).toString();
        }
    }
